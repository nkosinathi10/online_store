...
<form action="search.php" method="post">
    ...
    <input type="text" name="min_price" class="price-rage" placeholder="Min R" value="<?=$min_price;?>"> To 
    <input type="text" name="max_price" class="price-rage" placeholder="Max R" value="<?=$max_price;?>">
    <h4 class="text-center">Brand</h4>
    <input type="hidden" name="cat" value=""<?=(($b=='')?' checked':'');?>><br>
