...
$productQ = $db->query("SELECT i.id as 'id', i.title as 'title', c.id as 'cid', c.categories as 'child', p.categories as 'parent' FROM products i LEFT JOIN categories c ON i.categories = c.id LEFT JOIN categories p ON c.categories = p.id WHERE i.id IN ({$ids})");
...
<div class="pull-right">
    ...
    <a href="orders.php?complete=1&cart_id=<?= $cart_id; ?>" class="btn btn-large btn-default">Order</a>
</div>